  ...
  return (
    <main>
      ...
      <ol className="how">
        ...
        <li>Link an email to your install to claim payouts (one command, magic-link verify). From <strong>$25</strong> you can cash out anytime: PayPal, gift card, or prepaid card. Or let it ride — linked balances over $250 or idle 12 months are paid out automatically.</li>
