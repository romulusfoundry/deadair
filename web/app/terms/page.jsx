  ...
  return (
    <main>
      ...
      <ol className="how">
        ...
        <li>Cashing out requires linking a verified email to your install. Minimum payout is $25, fulfilled via PayPal, gift card, or prepaid card through a third-party payout provider.</li>
